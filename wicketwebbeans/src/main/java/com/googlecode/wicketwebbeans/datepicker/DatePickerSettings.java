...
public class DatePickerSettings implements Serializable
{
	...
	private static final Map<String, String> localeToLanguageReference =
	...
	static
	{
		...
		localeToLanguageReference.put(new Locale("es", "AR", "").toString(),
				"lang/calendar-es_AR.js");
